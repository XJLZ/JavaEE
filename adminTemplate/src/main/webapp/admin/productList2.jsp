                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <div>
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        <li ><a href="${pageContext.request.contextPath}/findProductByPage?categoryId=${categoryId}&currentPage=1&rows=${row}">首页</a></li>
                                    <c:if test="${pb.currentPage == 1}">
                                            <li class="disabled">
                                        </c:if>
                                        <c:if test="${pb.currentPage != 1}">
                                            <li>
                                            <a href="${pageContext.request.contextPath}/findProductByPage?categoryId=${categoryId}&currentPage=${pb.currentPage - 1}&rows=${row}" aria-label="Previous">
                                            </c:if>
                                        ...
                                        <c:forEach begin="${begin}" end="${end}" var="i">
                                            <c:if test="${pb.currentPage == i}">
                                                <li class="active"><a href="${pageContext.request.contextPath}/findProductByPage?categoryId=${categoryId}&currentPage=${i}&rows=${row}">${i}</a></li>
                                            </c:if>
                                            <c:if test="${pb.currentPage != i}">
                                                <li><a href="${pageContext.request.contextPath}/findProductByPage?categoryId=${categoryId}&currentPage=${i}&rows=${row}">${i}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        ...
                                        <c:if test="${pb.currentPage != pb.totalPage}">
                                            <li>
                                            <a href="${pageContext.request.contextPath}/findProductByPage?categoryId=${categoryId}&currentPage=${pb.currentPage + 1}&rows=${row}" aria-label="Next">
                                            </c:if>
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>
                                        </li>
                                            <li ><a href="${pageContext.request.contextPath}/findProductByPage?categoryId=${categoryId}&currentPage=${pb.totalPage}&rows=${row}">末页</a></li>
...
<script>
    $(function () {
        $("#category").change(function () {
            location.href = "${pageContext.request.contextPath}/findProductByPage?categoryId="+$("#category").val();
